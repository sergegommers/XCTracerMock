namespace XCTracerMock
{
  ...
  public interface IXCTracerSpp
  {
    ...
    public delegate void RxDataEventHandler(IXCTracerSpp sender, XCSppReceivedDataEventArgs ReadDataEventArgs);
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    public delegate void ConnectedEventHandler(IXCTracerSpp sender, EventArgs e);
